...
return [
    'invalidFormat'  => '"{0}" no es un formato de fecha y hora vÃƒÂ¡lido', // '"{0}" is not a valid datetime format',
    'invalidMonth'   => 'Los meses deben estar entre 1 y 12. Establecido: {0}',
    'invalidDay'     => 'Los dÃƒÂ­as deben estar entre 1 y 31. Establecido: {0}',
    'invalidOverDay' => 'Los dÃƒÂ­as deben estar entre 1 y {0}. Establecido: {1}',
    ...
    'years'          => '{0, plural, =1{# aÃƒÂ±o} other{# aÃƒÂ±o}}',
    'months'         => '{0, plural, =1{# mes} other{# meses}}',
    'weeks'          => '{0, plural, =1{# semana} other{# semanas}}',
    'days'           => '{0, plural, =1{# dÃƒÂ­a} other{# dÃƒÂ­as}}',
