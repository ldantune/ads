...
return [
    'invalidCellMethod'     => '{class}::{method} no es un mÃƒÂ©todo vÃƒÂ¡lido.',
    'missingCellParameters' => '{class}::{method} no tiene parÃƒÂ¡metros.',
    'invalidCellParameter'  => '{0} no es un nombre de parÃƒÂ¡metro vÃƒÂ¡lido.',
