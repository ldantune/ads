        ...
        <div class="widget user-dashboard-menu">
            <ul>
                ...
                <form method="POST" action="<?= route_to('logout') ?>">
                    <li>
                        <?php echo csrf_field(); ?>
                        <button class="btn btn-default bg-white p-0 py-2 pl-2 text-dark" type="submit"><i class="fa fa-power-off"></i> <?php echo lang('App.btn_logout') ?></button>
                    </li>
                </form>
            </ul>
        </div>
