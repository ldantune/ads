<!-- Modal -->
<div class="modal fade" id="modalAdvert" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="modalAdvertLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalAdvertLabel"><?php echo lang('Adverts.title_new'); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?php echo form_open(route_to('create.advert.my'), ['id' => 'adverts-form'], ['id' => '']); ?>
            <div class="modal-body">
                <div class="form-row">
                    <div class="mb-3 form-group col-md-12">
                        <label for="title" class="col-form-label"><?php echo lang('Adverts.label_title'); ?></label>
                    ...
                    <div class="mb-3 form-group col-md-3">
                        <label for="situation" class="col-form-label"><?php echo lang('Adverts.label_situation'); ?></label>
                        <div class="boxSituations" id="boxSituations"></div>
                        <span class="text-danger error-text situation"></span>
                    </div>

                    <div class="mb-3 form-group col-md-6">
                        <label for="category_id" class="col-form-label"><?php echo lang('Adverts.label_category'); ?></label>
                        <div class="boxCategories" id="boxCategories"></div>
                        <span class="text-danger error-text category_id"></span>
                    </div>

                    <div class="mb-3 form-group col-md-3">
                        <label for="price" class="col-form-label"><?php echo lang('Adverts.label_price'); ?></label>
                    ...
                    <div class="mb-3 form-group col-md-3">
                        <label for="zipcode" class="col-form-label"><?php echo lang('Adverts.label_zipcode'); ?></label>
                    ...
                    <div class="mb-3 form-group col-md-6">
                        <label for="street" class="col-form-label"><?php echo lang('Adverts.label_street'); ?></label>
                    ...
                    <div class="mb-3 form-group col-md-3">
                        <label for="number" class="col-form-label"><?php echo lang('Adverts.label_number'); ?></label>
                    ...
                    <div class="mb-3 form-group col-md-3">
                        <label for="neighborhood" class="col-form-label"><?php echo lang('Adverts.label_neighborhood'); ?></label>
                    ...
                    <div class="mb-3 form-group col-md-3">
                        <label for="city" class="col-form-label"><?php echo lang('Adverts.label_city'); ?></label>
                    ...
                    <div class="mb-3 form-group col-md-3">
                        <label for="state" class="col-form-label"><?php echo lang('Adverts.label_state'); ?></label>
                    ...
                    <div class="mb-3 form-group col-md-12">
                        <label for="description" class="col-form-label"><?php echo lang('Adverts.label_description'); ?></label>
                        <textarea class="form-control" id="description" style="min-height: 100px;" name="description"
                            placeholder="<?php echo lang('Adverts.label_description'); ?>"></textarea>
